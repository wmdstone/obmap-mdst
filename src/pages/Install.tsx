    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="border-b border-border">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <Badge
            variant="outline"
            className={`gap-1.5 ${isOnline ? "text-primary" : "text-destructive"}`}
          >
            {isOnline ? (
        ...
        <div className="max-w-2xl mx-auto space-y-8">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground max-w-md mx-auto">
              Get quick access from your home screen with offline support and a
              ...
              <CardContent className="p-6 flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    VaultGraph is installed on your device. You can open it from
                    your home screen.
                  </p>
                </div>
              </CardContent>
          ...
          <Card className="bg-card/50 border-border">
            <CardHeader>
              ...
              <CardDescription>
                VaultGraph works on all major platforms
              </CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <div className="space-y-3">
              <Card className="bg-card/50 border-border">
                <CardContent className="p-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Your data is stored locally by default. Use the backup
                    feature to export and import across devices.
                  </p>
                </CardContent>
              </Card>
              <Card className="bg-card/50 border-border">
                <CardContent className="p-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Yes! VaultGraph is fully functional offline. Changes sync
                    when you reconnect.
                  </p>
                </CardContent>
              </Card>
              <Card className="bg-card/50 border-border">
                <CardContent className="p-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Remove VaultGraph like any other app - long press on mobile
                    or use your OS's app management.
                  </p>
                </CardContent>
              </Card>
            </div>
