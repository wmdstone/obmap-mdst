...
import {
  VaultLocationBadge,
  VaultStorageControls,
} from "./VaultStorageControls";
...
export const VaultCard = ({
  ...
  const getIconColorClass = () =>
    location === "folder" ? "text-primary" : "text-blue-400";
  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex-1">
        ...
        <div className="flex items-start justify-between gap-3 mb-4">
          <div className="flex items-center gap-3 min-w-0 flex-1">
            <div
              className={`flex-shrink-0 p-2 rounded-lg bg-secondary ${getIconColorClass()}`}
            >
              {getVaultIcon()}
            </div>
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="flex items-center gap-2 mt-1">
                <VaultLocationBadge location={location} cloudSync={cloudSync} />
                {isActive && (
        ...
        {/* Storage: location + cloud sync (independent) */}
        <div className="mb-4">
          <VaultStorageControls
            location={location}
            cloudSync={cloudSync}
      ...
      {(onOpenBackups || onExportToFileSystem) && (
        <>
          <Separator />
