        ...
        <div className="w-full max-w-3xl space-y-8">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-base sm:text-lg text-muted-foreground max-w-md mx-auto">
              Create or open a vault to start building your connected knowledge
              base.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {[
              ...
              },
              {
                ...
                desc: "Write with wikilinks",
              },
              {
                icon: isAuthenticated ? Cloud : Link2,
                label: isAuthenticated ? "Cloud Sync" : "Auto-linking",
                desc: isAuthenticated ? "Access anywhere" : "Smart backlinks",
              },
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Store as files on your computer with full file system
                    access.
                  </p>
                </div>
              </div>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <Badge variant="outline" className="text-[10px]">
                      {isAuthenticated ? "Synced" : "Sign in required"}
                    </Badge>
                  </div>
                  <p className="text-sm text-muted-foreground">
                    {isAuthenticated
                      ? "Stored in your account. Open it from any device."
                      : "Sign in to keep a vault in your account."}
                  </p>
                </div>
              </div>
              <ArrowRight className="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 text-muted-foreground opacity-0 group-hover:opacity-100 group-hover:translate-x-1 transition-all" />
