  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Mandatory properties always appear at the top of a note. Everything
            else can be tucked into the collapsible section.
          </p>
        </div>
        <Button
          variant="ghost"
      ...
      <div className="flex items-center justify-between gap-4 rounded-lg border border-border p-3">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5">
            Warn when mandatory properties are empty. Blocking saves arrives
            with the linter.
          </p>
        </div>
          ...
          >
            <div className="flex items-center gap-2">
              <Input
                value={rule.key}
                onChange={(e) =>
                  updateProperty(rule.key, { key: e.target.value })
                }
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="space-y-1.5">
                ...
                <Select
                  value={rule.type}
                  onValueChange={(v) =>
                    updateProperty(rule.key, { type: v as SchemaPropertyType })
                  }
                >
              ...
              <div className="space-y-1.5">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    updateProperty(rule.key, {
                      visibility: v as PropertyVisibility,
                    })
                  }
                >
                  <SelectTrigger className="h-8 text-xs">
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateProperty(rule.key, { defaultValue: e.target.value })
                  }
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateProperty(rule.key, { taxonomyPrefix: e.target.value })
                  }
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <Switch
                ...
                onCheckedChange={(v) =>
                  updateProperty(rule.key, { required: v })
                }
              />
            </div>
          </div>
      ...
      <p className="text-xs text-muted-foreground">
        A single note can override any rule by adding a{" "}
        <code className="font-mono">schema:</code> block to its own properties.
      </p>
    </div>
  );
}
