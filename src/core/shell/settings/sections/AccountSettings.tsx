...
import { ProfileSettings } from "@/core/shell/profile/components/ProfileSettings";
import { AvatarUpload } from "@/core/shell/profile/components/AvatarUpload";
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Sign in to sync vaults across devices, manage API keys and use
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader className="pb-3">
          ...
          <CardDescription>
            Who you are signed in as on this device.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Badge
              variant={profile?.email_verified ? "default" : "outline"}
              className="text-xs"
            >
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            <p className="text-xs text-muted-foreground">
              Signing out keeps local vaults on this device, but stops cloud
              sync.
            </p>
            <Button
              variant="outline"
