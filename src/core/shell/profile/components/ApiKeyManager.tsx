...
} from "@/core/shell/profile/services/ApiKeyService";
...
export function ApiKeyManager() {
  ...
  const handleCreateKey = async () => {
    ...
    setIsCreating(true);
    const expiresInDays = newKeyExpiresDays
      ? parseInt(newKeyExpiresDays)
      : undefined;
      ...
      <CardContent>
        {apiKeys.length === 0 ? (
          <div className="text-center py-8 text-muted-foreground">
            ...
            <p>No API keys yet</p>
            <p className="text-sm">
              Create an API key to access your vaults programmatically
            </p>
          </div>
        ) : (
