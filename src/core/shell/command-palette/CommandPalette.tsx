...
import {
  ...
  formatHotkey,
  type Command,
} from "@/core/system/commands/CommandRegistry";
import { subscribeActiveEditor } from "@/core/editor/activeEditor";
import { onOpenCommandPalette } from "@/core/shell/command-palette/paletteEvents";
import { useFeatureEnabled } from "@/core/system/plugins/useFeatureEnabled";
import type { EditorApi } from "@/core/editor/types";
